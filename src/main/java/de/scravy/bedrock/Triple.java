...
public class Triple<A, B, C> implements Serializable, Comparable<Triple<A, B, C>>, Tuple3<A, B, C> {
  ...
  @Nonnull
  public de.scravy.bedrock.hlist.C<A, de.scravy.bedrock.hlist.C<B, de.scravy.bedrock.hlist.C<C, Nil>>> toHList() {
    return toHList3();
  }

  @Nonnull
  public static <A, B, C, L extends HList<L>> Triple<A, B, C> fromHList(
    @Nonnull final de.scravy.bedrock.hlist.C<A, de.scravy.bedrock.hlist.C<B, de.scravy.bedrock.hlist.C<C, L>>> hlist) {
